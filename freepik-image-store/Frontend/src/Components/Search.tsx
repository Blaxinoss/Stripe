                            ...
                            <div className="p-8">
                                ...
                                <div className="text-center mb-8">
                                    ...
                                    <div className="bg-blue-500/20 border border-blue-500/30 rounded-xl p-3 mb-4">
                                        <p className="text-blue-200 text-[0.6rem] flex items-center justify-center gap-2">
                                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10" />
                                            </svg>
                                            Auto-download available for photos and Zip files. Refer to the gellery for all your downloads.
                                        </p>
                                    </div>
